...
int n;
cin>>n;
int num=1,n1,n2,n3,n4;
switch(num){
  case 1:{
    cout<<"Total 100 Rs notes needed:";
    cout<<n/100<<endl;
    n1=n/100;
    n=n-n1*100;
  }
  case 2:{
    cout<<"Total 50 Rs notes needed:";
    cout<<n/50<<endl;
    n2=n/50;
    n=n-n2*50;
